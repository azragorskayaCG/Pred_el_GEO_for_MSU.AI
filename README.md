...
- [files_solar_wind](https://github.com/azragorskayaCG/Pred_el_GEO_for_MSU.AI/tree/main/data/files_solar_wind) contains the solar wind parameters: proton density; Solar wind synamic pressure, Bulk speed, Ion tempeture, GSM B_x, GSM B_y, GSM B_z, GSM B_t
- [files_flux_and_others](https://github.com/azragorskayaCG/Pred_el_GEO_for_MSU.AI/tree/main/data/files_flux_and_others) contains the flux and magnetosphere parameters: E >0.8 MeV, E >2.0 MeV, Hp, He, Hn, B, Rss(Shue)
